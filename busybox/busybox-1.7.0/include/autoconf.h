 ...
 */
#define AUTOCONF_TIMESTAMP "2017-10-04 11:42:11 CST"
...
#define USE_BUILD_LIBBUSYBOX(...) __VA_ARGS__
#define SKIP_BUILD_LIBBUSYBOX(...)
...
#define USE_FEATURE_SHARED_BUSYBOX(...) __VA_ARGS__
#define SKIP_FEATURE_SHARED_BUSYBOX(...)
#define CONFIG_LFS 1
#define ENABLE_LFS 1
